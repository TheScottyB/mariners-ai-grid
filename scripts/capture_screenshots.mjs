...
/**
 * Script to automate screenshot capture and verification for Mariner's AI Grid.
 */
...
const SCREENSHOT_SCENES = [
  { key: 'front', suffix: '', desc: 'Main weather map grid and vessel tracking layout' },
  { key: 'onboarding', suffix: '_onboarding', desc: 'First Watch Onboarding screen' },
  { key: 'hazard', suffix: '_hazard', desc: 'Debris/iceberg hazard observation overlay' }
];
...
async function main() {
  console.log("Welcome to Mariner's AI Grid Screen Capture & Scaler Tool!");
